...
public class RedisClientFactory {
    ...
    public static RedisClient buildSentinelRedisClient(String redisNodeStr, String requirePass, String master) {
        Set<HostAndPort> nodes = RedisUtil.nodesToHostAndPortSet(redisNodeStr);
        RedisURI redisURI = new RedisURI(nodes, requirePass, null, master, 0);
        return buildRedisClient(redisURI);
    }
