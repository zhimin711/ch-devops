 ...
 */
package com.ch.cloud.rocketmq.admin;

import com.ch.cloud.rocketmq.admin.annotation.MultiMQAdminCmdMethod;
import com.ch.cloud.rocketmq.service.client.MQAdminInstance;
...
public class MQAdminAspect {
    ...
    @Pointcut("execution(* com.ch.cloud.rocketmq.service.client.MQAdminExtImpl..*(..))")
    public void mQAdminMethodPointCut() {

    }

    @Pointcut("@annotation(com.ch.cloud.rocketmq.admin.annotation.MultiMQAdminCmdMethod)")
